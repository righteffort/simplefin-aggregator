...
from simplefin_aggregator.auth import require_client_auth
...
def _protected_client(config: Config) -> TestClient:
    ...
    @app.get("/protected", dependencies=[Depends(require_client_auth)])
...
def test_require_client_auth_accepts_correct_credentials() -> None:
